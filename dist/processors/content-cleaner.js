...
export class ContentCleaner {
     ...
     */
    async cleanDocument(document, teamId, userId) {
        try {
     ...
     */
    async cleanAndExportDocuments(documents, teamId, userId, outputPath) {
        try {
...
- MAINTAIN PROPER PARAGRAPH STRUCTURE WITH LINE BREAKS`;
     ...
     */
    parseCleanedResponse(cleanedResponse, originalDocument) {
        try {
            // Extract title
     ...
     */
    mapToValidContentType(detectedType, originalDocument) {
        if (!detectedType) {
     ...
     */
    async saveExportData(exportData, outputPath) {
